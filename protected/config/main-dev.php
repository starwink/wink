...
//		),
	...
	'components'=>array(
        ...
        'db'=>array(
            'connectionString' => 'mysql:host=dev IP;dbname=dev database name',
            'emulatePrepare' => true,
		...
		'db2'=>array(
			'class' => 'CDbConnection',
			'connectionString' => 'mysql:host=dev IP;dbname=information_schema',
			'emulatePrepare' => true,
			'username' => 'dev username',
			'password' => 'dev password',
			'charset' => 'utf8mb4',
	...
	'params'=>array(
		...
		'wx_appID'=>'dev appID',
		'wx_appsecret'=>'dev appsecret',
		'wx_EncodingAESKey'=>'dev EncodingAESKey'
	),
);
